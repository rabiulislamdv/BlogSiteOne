                    ...
                    <div class="row">
                        <div class="col-lg-3 col-md-6">
                            <article class="post-grid mb-5">
                                ...
                                <h3 class="post-title mt-1"><a href="">The best place to explore to enjoy</a></h3>
                        ...
                        <div class="col-lg-3 col-md-6">
                            <article class="post-grid mb-5">
                                ...
                                <h3 class="post-title mt-1"><a href=" ">How to Make list for travelling alone</a></h3>
                        ...
                        <div class="col-lg-3 col-md-6">
                            <article class="post-grid mb-5">
                                ...
                                <h3 class="post-title mt-1"><a href=" ">5 ingredient cilantro vinaigrette</a></h3>
                        ...
                        <div class="col-lg-3 col-md-6">
                            <article class="post-grid mb-5">
                                ...
                                <h3 class="post-title mt-1"><a href=" ">A Simple Way to Feel Like Home When You Travel</a></h3>
                        ...
                        <div class="col-lg-3 col-md-6">
                            <article class="post-grid mb-5">
                                ...
                                <h3 class="post-title mt-1"><a href=" ">What Type of Traveller Are You?</a></h3>
                        ...
                        <div class="col-lg-3 col-md-6">
                            <article class="post-grid mb-5">
                                ...
                                <h3 class="post-title mt-1"><a href=" ">A Road Trip Review of the 2018</a></h3>
                        ...
                        <div class="col-lg-3 col-md-6">
                            <article class="post-grid mb-5">
                                ...
                                <h3 class="post-title mt-1"><a href=" ">Portugal’s Sunset summer vission</a></h3>
                        ...
                        <div class="col-lg-3 col-md-6">
                            <article class="post-grid mb-5">
                                ...
                                <h3 class="post-title mt-1"><a href=" ">The best soft Tropical Getaway</a></h3>
                        ...
                        <div class="col-lg-3 col-md-6">
                            <article class="post-grid mb-5">
                                ...
                                <span class="cat-name text-color font-sm font-extra text-uppercase letter-spacing">Travel</span>
                                <h3 class="post-title mt-1"><a href=" ">Memoriable Paris Girls Trip </a></h3>
                        ...
                        <div class="col-lg-3 col-md-6">
                            <article class="post-grid mb-5">
                                ...
                                <span class="cat-name text-color font-sm font-extra text-uppercase letter-spacing">Experience</span>
                                <h3 class="post-title mt-1"><a href=" ">How to Plan your Trip the Right Way</a></h3>
                        ...
                        <div class="col-lg-3 col-md-6">
                            <article class="post-grid mb-5">
                                ...
                                <span class="cat-name text-color font-sm font-extra text-uppercase letter-spacing">Travel</span>
                                <h3 class="post-title mt-1"><a href=" ">8 Powerful Ways to Add Vibrant Colour to Your Life</a></h3>
                        ...
                        <div class="col-lg-3 col-md-6">
                            <article class="post-grid mb-5">
                                ...
                                <span class=" cat-name text-color font-sm font-extra text-uppercase letter-spacing">Lifestyle</span>
                                <h3 class="post-title mt-1"><a href=" ">The best to-do list to help boost your productivity</a></h3>
